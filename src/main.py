...
async def get_data(request: Request):
    ...
    if is_intent_the_same(intent_display_name, "vague.city-livingthere"):
        ...
        return get_city_trip_plan_process(data)    
    elif is_intent_the_same(intent_display_name,"random.recommendation") or is_intent_the_same(intent_display_name, "vague.gothere.yes") or is_intent_the_same(intent_display_name, "country.from.yes") or is_intent_the_same(intent_display_name, "city.from.settings.yes"):
